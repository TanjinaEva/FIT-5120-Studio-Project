...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = 'iteration2_724c684aea8fc2851584_20201012001911_archive.zip';
    const ARCHIVE_SIZE       = '260842250';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '724c684-12001911';
    const VERSION            = '3.8.6.1';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.6.1==');
        $this->log('----------------------------------------------------');
