...
<div class="section-tests">
	...
	<form>
		...
		<div class="params">
			...
			<input type="text" name="scan-path" value="<?php echo duplicator_pro_get_root_path(); ?>" /> <br/>
		</div>
	</form>
	...
	<form>
		...
		<div class="params">
			...
			<label>Search Path:</label> 
			<input type="text" name="scan-path" value="<?php echo esc_html(duplicator_pro_get_root_path()); ?>" /> <br/>
		</div>
	</form>
