...
DUPX_U_Html::getHeaderMain('HELP');
?>
<!-- =========================================
HELP FORM -->
<div id="main-help">
        ...
        <div class="content" >
            ...
            <div id="dup-help-scanner" class="help-page">
                ...
                <table class="help-opt">
                    ...
                    <tr>
                        <td>Inactive Plugins and Themes</td>
                        <td>
                            If this option is checked, only active themes and plugin will exists in the installed sites. When checked for a subsite to standalone migration, only active users will retain.
                        </td>
                    </tr>
            ...
            <div id="dup-help-step2" class="help-page">
                ...
                <table class="help-opt">
                    ...
                    <tr>
                        ...
                        <td>Each wp-config value has an associated switch that controls the insertion and removal of the constant.<br>
                            If the switch is deactivated, the constant will be removed from wp-config.php</td>
                    </tr>
                    <tr>
                        <td class="col-opt">Constants</td>
                        <td>The wp-config tab contains the list of constants that can be modified directly by the installer.<br>
                    ...
                    <tr>
                        ...
                        <td>Generate New Unique Authentication Keys and Salts. 
                        Defines: AUTH_KEY, SECURE_AUTH_KEY, LOGGED_IN_KEY, NONCE_KEY, AUTH_SALT, SECURE_AUTH_SALT, LOGGED_IN_SALT, NONCE_SALT</td>
                    </tr>
                    <tr>
