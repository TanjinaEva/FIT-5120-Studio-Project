			...
			<div id="dup-exportdb-items-off">
				...
				<div id="dup-file-filter-items">
					...
					<div class='dup-quick-links'>
						<a href="javascript:void(0)" onclick="DupPro.Pack.AddExcludePath('<?php echo esc_js(duplicator_pro_get_root_path()); ?>')">[<?php DUP_PRO_U::esc_html_e("root path") ?>]</a>
					...
					<div class='dup-quick-links'>
						<a href="javascript:void(0)" onclick="DupPro.Pack.AddExcludeFilePath('<?php echo esc_js(duplicator_pro_get_root_path()); ?>')"><?php DUP_PRO_U::esc_html_e("(file path)") ?></a>
