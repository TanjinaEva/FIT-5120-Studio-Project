...
<table class="dpro-edit-toolbar">
    <tr>
        ...
        <td>
			<?php include('create.package.nav.buttons.php'); ?>
        </td>
    </tr>
</table>
			...
			success: function (respData, textStatus, xHr) {
				...
				if(data.ScanStatus !== undefined && data.ScanStatus == 'running'){
                    ...
                    if (status == DupPro.Pack.WebServiceStatus.Pass) {
                        ...
                        message += '<br><b><?php DUP_PRO_U::esc_html_e("Please Retry:") ?></b><br/>';
                        ...
                        message += '<?php DUP_PRO_U::esc_html_e("Scan Path:") ?> [<?php echo esc_html(duplicator_pro_get_root_path()); ?>]<br/><br/>';
