...
class DUP_PRO_Extraction
{
    ...
    public function runZipArchiveChunking($chunk = true)
    {
        ...
        $skipWpCoreFailExtractionWarning = DUPX_Custom_Host_Manager::getInstance()->isManaged();
        $hostMng                         = DUPX_Custom_Host_Manager::getInstance();
                    ...
                    if (
                        ...
                        try {
                            ...
                            if (!$zip->extractTo($this->root_path, $extract_filename)) {
                                if ($hostMng->skipWarningExtractionForManaged($extract_filename)) {
