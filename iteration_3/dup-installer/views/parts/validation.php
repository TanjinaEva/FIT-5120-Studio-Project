...
<div id="s1-area-sys-setup" class="hdr-sub1-area no-display" >
    ...
    <div class="s1-reqs" id="s1-reqs-all">
        ...
        <!-- REQ 50 -->
        <div class="status <?php echo strtolower($req['50']); ?>"><?php echo $req['50']; ?></div>
        ...
        <!-- REQ 60 -->
        <?php if ($req['60'] === 'Fail') { ?>
            <div class="status <?php echo strtolower($req['60']); ?>"><?php echo $req['60']; ?></div>
    ...
    <div class="s1-reqs" id="s1-notice-all">
        ...
        <?php elseif (DUPX_Conf_Utils::isConfArkPresent()) : ?>
            ...
            <div class="info" id="s1-notice20">
                ...
                <small>Note: This test looks for a file named <i>dup-wp-config-arc__[HASH].txt</i> in the <?php echo DUPX_U::esc_html(basename(DUPX_INIT)); ?> directory.  If the file exists then this notice is shown.
